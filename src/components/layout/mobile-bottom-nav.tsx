  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 md:hidden">
      <div className="glass border-t border-border/50">
        <div className="flex items-center justify-around h-[4.5rem] pb-[env(safe-area-inset-bottom)]">
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  {label === 'Cart' && count > 0 && (
                    <span className="absolute -top-1.5 -right-3 h-4 min-w-[1rem] flex items-center justify-center rounded-full bg-pink text-[9px] font-bold text-white px-0.5">
                      {count}
                    </span>
                  )}
                </div>

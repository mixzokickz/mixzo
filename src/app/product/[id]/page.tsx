        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <div className="aspect-square relative rounded-3xl bg-[#1A1A22] border border-[#1E1E26] overflow-hidden group">
                {gallery.length > 0 ? (
                  <>
              ...
              {gallery.length > 1 && (
                <div className="flex gap-3 overflow-x-auto no-scrollbar">
                  {gallery.map((img, i) => (
                    ...
                    >
                      <Image src={img} alt="" width={72} height={72} className="w-full h-full object-contain p-1.5 bg-[#1A1A22] drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]" />
                    </button>
                  ))}
                </div>
              )}
